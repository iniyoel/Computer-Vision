...
# Buat folder output untuk HE, CS, dan CLAHE
...
def contrast_stretching(image):
    # Mendapatkan nilai minimum dan maksimum dari pixel
...
for subfolder in os.listdir(input_folder):
    ...
    if os.path.isdir(subfolder_path):
        # Buat subfolder untuk hasil HE, CS, dan CLAHE di masing-masing folder output
