...
input_folder = 'output_frames'  # Folder dengan frame asli
output_folder = 'output_grayscale_frames'  # Folder untuk hasil grayscale
...
for subfolder in os.listdir(input_folder):
    ...
    if os.path.isdir(subfolder_path):
        # Buat subfolder baru di dalam output_grayscale_frames
