...
folder_path = 'Data Vidio UTS/Basketball'  # Ganti dengan path folder video Anda
output_base_folder = 'output_frames'  # Folder untuk menyimpan semua frame

# Membuat folder utama untuk menyimpan frame
...
for filename in os.listdir(folder_path):
    if filename.endswith('.mp4') or filename.endswith('.avi'):  # Filter video dengan format mp4 atau avi
        ...
        # Membuat subfolder untuk setiap video berdasarkan nama file video
